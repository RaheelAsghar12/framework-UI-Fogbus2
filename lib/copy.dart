        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: actor.isRunning ? Text('Running') : Text('Run Actor'),
            ),
            ElevatedButton(
              onPressed: () {
                Navigator.push(
              ...
              child: user.isRunning ? Text('Running') : Text('Run User'),
            ),
            ElevatedButton(
              onPressed: () {
                Navigator.push(
              ...
              child: master.isRunning ? Text('Running') : Text('Run Master'),
            ),
          ],
        ),
      ),
